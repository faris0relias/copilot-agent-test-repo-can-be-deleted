...
param resourceGroupName = 'sbox-us-content-library-service-rg'
param envPrefix = 'sbox-us'
...
param apiHostname = 'sandbox-content-library-serviceapi.reliaslearning.com'
...
param consumerHostname = 'sbox-cls-consumer.reliaslearning.com'
...
param sqlServerName = 'sbox-ncus-lms-sqlmi-001.cdd4505f7831.database.windows.net'
param identityUri = 'https://sandbox-login.reliaslearning.com'
param rusticiClientUrl = 'https://dev1-engine.reliaslearning.com/engine'
param serviceBusResourceGroupName = 'sbox-us-sb-rg'
